...
<template>
    <section class="w-full flex flex-col items-center justify-center pt-12">
        <div class="w-[85vw] sm:w-[400px] min-h-[60vh] bg-white rounded shadow-md flex flex-col pb-2">
            <div class="w-full relative">
                <!-- Modal header -->
                <div class="px-6 py-3 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-lg font-semibold text-gray-900 lg:text-2xl dark:text-white">Add child</h3>
                </div>
            </div>
            <div class="w-full flex flex-col gap-y-3.5 px-6 py-3">
                <div>
                    <label for="full_name" class="block mb-2 sm:mb-1 text-sm sm:text-base font-medium text-gray-900 dark:text-white"
                        >Full name</label
                    >
                    <input
                        type="text"
                ...
                <div class="">
                    <label for="dob" class="block mb-2 sm:mb-1 text-sm sm:text-base font-medium text-gray-900 dark:text-white"
                        >Date of birth</label
                    >
            ...
            <div class="w-full flex flex-row gap-x-2 items-center py-3.5 px-6">
                <button
                    ...
                    type="button"
                    class="w-full text-white bg-blue-700 hover:bg-blue-800 focus:ring-2 focus:ring-blue-300 font-medium rounded-lg text-base sm:text-lg px-5 py-2.5 flex items-center justify-center relative"
                >
